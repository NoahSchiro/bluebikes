...
# The station names below can have a lot of weird symbols in them
# and we might want to use these names as file paths so this function
# will remove the problematic characters
def station_name_preprocess(name):
...
# Stations with more than 15000 trips in 2024
# This is what we will train on
stations_of_consequence = {
